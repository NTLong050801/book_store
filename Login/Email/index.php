...
try {
    ...
    $mail->CharSet = 'UTF-8';
    //Recipients
    $mail->setFrom('loglog050801@gmail.com', 'Văn phòng Khoa CNTT - Trường ĐH Thủy lợi');

    $mail->addReplyTo('loglog050801@gmail.com', 'Văn phòng Khoa CNTT - Trường ĐH Thủy lợi');
      
    $mail->addAddress('Vuong9xx@gmail.com'); // Add a recipient
    ...
    // Mail body content 
    $bodyContent = '<p>Thân gửi Tân sinh viên <b>Nguyễn Minh Vương</b></h1>'; 
    ...
    $bodyContent .= '<p>Mọi thắc mắc xin liên hệ Phòng Đào tạo – Trường Đại học Thủy lợi, Số điện thoại <b>0243.563.1537</b>, Email: <b>tuyensinh@tlu.edu.vn </b>, <b>1951060829@e.tlu.edu.vn</b> </p>' ; 
