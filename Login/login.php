            ...
            <div class="row d-flex align-items-center justify-content-center ">
                ...
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    ...
                    <form id="form" action="" method="post">
                        ...
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary btn-lg btn-block login" name="submit">Đăng nhập</button>
                        <a href="signup.php"><button type="button" id="dangky" class="btn btn-secondary btn-block" name="btn_dky" style="margin-top: 20px;">Đăng ký</button></a>
                        <?php
